            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-white/90">
                  {doctorDetails?.specialization || userDetails?.email}
                </p>
            ...
            {!editing ? (
              <>
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <p className="text-sm font-medium text-gray-600 flex items-center gap-2">
                        <FiPhone className="text-primary" /> Contact Number
                      </p>
                      <p className="text-lg text-gray-800 font-semibold">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <p className="text-sm font-medium text-gray-600 flex items-center gap-2">
                        <FiAward className="text-primary" /> License Number
                      </p>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-lg text-gray-800 font-semibold">
                        {doctorDetails?.yearsOfExperience ?? "N/A"}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block mb-1 text-primary-dark">Contact Number</label>
                    <input
                      type="tel"
                      name="contact"
                  ...
                  <div>
                    <label className="block mb-1 text-primary-dark">Specialization</label>
                    <input
                      type="text"
                      name="specialization"
                  ...
                  <div>
                    <label className="block mb-1 text-primary-dark">License Number</label>
                    <input
                      type="text"
                      name="licenseNumber"
